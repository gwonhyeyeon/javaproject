...
//작성법
//1. 스토리보드 표지엔 프로젝트 명, 문서버전 정보, 최종 업데이트 일자, 작성자 등의 정보 기재
//	- 협업 프로젝트에서 버전 관리 정보가 중요하다. 팀전체가 내용을 공유,
// 	유기적 개발 진행
//Wireframe
//1. UI 중심의 화면 레이아웃을 설계하여 선과 뼈대를 만드는 것
//	시각적인 프레임워크, 버튼 배치, 페이지 요소 등의 계층 구조 등
//	페이지 구조와 구조성 측면의 결과를 통합적으로 적응하는 작업이다. 
//1. Mockup : 실물과 흡사한 (정적인) 형태의 모형이며 서비스 개발 전에 결과물을 그려보는 것
