...
//컨텐트팬은 Container타입이므로 Container를 상속받은 어떤 컴포넌트도 컨텐트팬이 될 수 있다.
	...
	class GamePanel extends JPanel {
		...
		public GamePanel(char quitChar, long monsterDelay) {
...
//			this.monsterChar = monsterChar;
			...
			// 아바타와 괴물 레이블 생성
			ImageIcon head = new ImageIcon("src/images/jajang.png");
			avatar = new JLabel(head);
			ImageIcon head1 = new ImageIcon("src/images/jjambbong.png");
			monster = new JLabel(head1);
